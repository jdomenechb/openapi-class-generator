...
use Jdomenechb\OpenApiClassGenerator\CodeGenerator\Nette\NetteSchemaCodeGenerator;
...
$app->add(
    new GenerateCommand(new CebeOpenapiApiBuilder(new CebeOpenapiFileReader(), new CebeOpenApiTypeFactory()), new NetteApiCodeGenerator(new NetteSchemaCodeGenerator()))
);
