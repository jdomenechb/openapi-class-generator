...
$app->add(
    new GenerateCommand(new CebeOpenapiApiBuilder(new CebeOpenapiFileReader(), new CebeOpenApiTypeFactory()), new NetteApiCodeGenerator(new NetteObjectSchemaCodeGenerator()))
);
